...
# def test_dihedral_is_grad():
#     net = DihedralLayer(99)
#     fake_input = torch.rand((64, 99, 3), requires_grad=True)
#     output = net(fake_input)

#     grad_res = torch.autograd.grad(-1 * torch.sum(
#         output), fake_input, create_graph=True, retain_graph=True)

#     ans = torch.rand((64, 99, 3), requires_grad=True)
