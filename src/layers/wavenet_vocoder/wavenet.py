...
class WaveNet(nn.Module):
    ...
    def __init__(self, input_size, out_channels=256, layers=20, stacks=2,
        ...
        if scalar_input:
            ...
            self.first_conv = Conv1d1x1(input_size, residual_channels)
    ...
    def incremental_forward(self, initial_input=None, c=None, g=None,
        ...
        for t in tqdm(range(T)):
            ...
            if self.scalar_input:
                ...
                x = F.softmax(
                    x.view(B, -1), dim=1) if softmax else x.view(B, -1)
                if quantize:
